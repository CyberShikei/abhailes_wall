...
class DBOperations:
    ...
    def create_table(self, create_table_query: str, table_name: str):
        ...
        Side Effects:
            - Executes the `create_table_query`
                to create the table if it does not exist.
            - Prints a success or information message
                regarding the table's creation status.
            - Logs an error message if the table creation fails.

        Raises:
            None: Any exceptions are caught and handled by logging
    ...
    def insert_data(self, table_name, data):
        ...
        Insert data into a table.
            (If the table doesn't exist, it creates it first.)
